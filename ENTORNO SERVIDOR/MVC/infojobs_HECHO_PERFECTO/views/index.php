...
<body>
    ...
    <?php foreach ($ofertas as $oferta): ?>
        <div style="border: 1px solid #ccc; padding: 5px 10px; margin-bottom: 10px; border-radius: 10px;">
            <p>
                ...
                <form action="?action=eliminarOferta" method="POST">
                    <input type="hidden" name="id" value="<?php echo $oferta->getId(); ?>">
                    <a href="?action=verOferta&id=<?=  (int)$oferta->getId(); ?>" style="margin-right: 10px;">Ver detalles de la oferta</a>
    ...
    <?php endforeach; ?>
    <a href="index.php?action=createOferta">Crear nueva oferta de trabajo</a>
</body>
</html>